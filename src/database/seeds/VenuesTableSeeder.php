    ...
    public function run()
    {
        DB::table('venues')->insert([
            [
                ...
                'zipcode' => '160-0021',
                'addr_pref_id' => array_search('東京都', config('pref')),
                'addr_prefecture' => '東京都',
                'addr_city' => '新宿区',
            ...
            [
                ...
                'zipcode' => '220-0011',
                'addr_pref_id' => array_search('神奈川県', config('pref')),
            ...
            [
                ...
                'zipcode' => '460-0011',
                'addr_pref_id' => array_search('愛知県', config('pref')),
                'addr_prefecture' => '愛知県',
                'addr_city' => '名古屋市中区',
                'addr_block' => '大須4-1-71',
            ...
            [
                ...
                'zipcode' => '542-0086',
                'addr_pref_id' => array_search('大阪府', config('pref')),
                'addr_prefecture' => '大阪府',
                'addr_city' => '大阪市中央区',
            ...
            [
                ...
                'zipcode' => '060-0061',
                'addr_pref_id' => array_search('北海道', config('pref')),
                'addr_prefecture' => '北海道',
                'addr_city' => '札幌市中央区',
                'addr_block' => '南1条西4-13',
            ...
            [
                ...
                'zipcode' => '980-0021',
                'addr_pref_id' => array_search('宮城県', config('pref')),
                'addr_prefecture' => '宮城県',
                'addr_city' => '仙台市青葉区',
                'addr_block' => '中央2-6-32',
            ...
            [
                ...
                'zipcode' => '604-0815',
                'addr_pref_id' => array_search('京都府', config('pref')),
                'addr_prefecture' => '京都府',
                'addr_city' => '京都市中京区',
                'addr_block' => '中町540',
            ...
            [
                ...
                'zipcode' => '700-0822',
                'addr_pref_id' => array_search('岡山県', config('pref')),
                'addr_prefecture' => '岡山県',
                'addr_city' => '岡山市北区',
                'addr_block' => '表町1-1-45',
                'addr_building' => null,
            ...
            [
                ...
                'zipcode' => '810-0021',
                'addr_pref_id' => array_search('福岡県', config('pref')),
                'addr_prefecture' => '福岡県',
                'addr_city' => '福岡市中央区',
            ...
            [
                ...
                'kana_name' => 'にじげんのもり',
                'zipcode' => '656-2301',
                'addr_pref_id' => array_search('兵庫県', config('pref')),
                'addr_prefecture' => '兵庫県',
                'addr_city' => '淡路市',
                'addr_block' => '楠本2425-2',
                'addr_building' => null,
            ...
            [
                ...
                'kana_name' => 'ひろしまくうこう',
                'zipcode' => '729-0416',
                'addr_pref_id' => array_search('広島県', config('pref')),
                'addr_prefecture' => '広島県',
                'addr_city' => '三原市本郷町',
                'addr_block' => '善入寺64-31',
                'addr_building' => null,
            ...
            [
                ...
                'kana_name' => 'りなしてぃかのや',
                'zipcode' => '893-0009',
                'addr_pref_id' => array_search('鹿児島県', config('pref')),
